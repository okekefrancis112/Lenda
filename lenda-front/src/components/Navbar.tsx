...
import Svg1 from "../assets/icon/svg1.svg";
import NftFont from "../assets/font/nfts.ttf";
                                    ...
                                    <div id="site-logo-inner">
                                        <a href="index-2.html" rel="home" className="main-logo">
                                            <img id="logo_header" src={Logo}
                                                 ...
                                                 data-retina={Logo} data-width="133"
                                                 data-height="56"/>
                                        </a>
                                    </div>
                                </div>
                                    ...
                                    <ul id="menu-primary-menu" className="menu">
                                        <li className="menu-item current-menu-item menu-item-has-children">
                                            ...
                                            <ul className="sub-menu">
                                                <li className="menu-item current-item"><a href="index-2.html">Home 1</a>
                                                </li>
                                                ...
                                                <li className="menu-item"><a href="home7.html">Home 7</a></li>
                                                <li className="menu-item"><a href="home8.html">Home 8 ( Special )</a>
                                                </li>
                                                <li className="menu-item menu-item-has-children">
                                                    <a href="#">Slider Styles</a>
                                                    <ul className="sub-menu">
                                                        <li className="menu-item"><a href="slider-typer-text.html">Text
                                                            Type</a></li>
                                                        <li className="menu-item"><a href="slider-scroll-text.html">Text
                                                            Scroll</a></li>
                                                        <li className="menu-item"><a href="slider-rotate-text.html">Text
                                                            Rotate</a></li>
                                                    </ul>
                                                </li>
                                            </ul>
                                        ...
                                        <li className="menu-item menu-item-has-children">
                                            <a href="#">Explore</a>
                                            <ul className="sub-menu">
                                                <li className="menu-item"><a href="explore-1.html">Explore Style 1</a>
                                                </li>
                                                <li className="menu-item"><a href="explore-2.html">Explore Style 2</a>
                                                </li>
                                                <li className="menu-item"><a href="explore-3.html">Explore Style 3</a>
                                                </li>
                                                <li className="menu-item"><a href="explore-4.html">Explore Style 4</a>
                                                </li>
                                                <li className="menu-item"><a href="auctions.html">Live Auctions</a></li>
                                                <li className="menu-item"><a href="item-details.html">Item Details</a>
                                                </li>
                                                <li className="menu-item"><a href="item-details-2.html">Item Details
                                                    2</a></li>
                                            </ul>
                                        </li>
                                        <li className="menu-item menu-item-has-children">
                                            <a href="#">Activity</a>
                                            <ul className="sub-menu">
                                                <li className="menu-item"><a href="activity1.html">Activity 1</a></li>
                                                <li className="menu-item"><a href="activity2.html">Activity 2</a></li>
                                            </ul>
                                        </li>
                                        <li className="menu-item menu-item-has-children">
                                            <a href="#">Community</a>
                                            <ul className="sub-menu">
                                                ...
                                                <li className="menu-item"><a href="help-center.html">Help Center</a>
                                                </li>
                                            </ul>
                                        </li>
                                        <li className="menu-item menu-item-has-children">
                                            <a href="#">Pages</a>
                                            <ul className="sub-menu">
                                                <li className="menu-item"><a href="author01.html">Authors</a></li>
                                                <li className="menu-item"><a href="author02.html">Authors 2</a></li>
                                                <li className="menu-item"><a href="connect-wallet.html">Wallet
                                                    Connect</a></li>
                                                <li className="menu-item"><a href="create-item.html">Create Item</a>
                                                </li>
                                                <li className="menu-item"><a href="profile.html">Edit Profile</a></li>
                                        ...
                                        <li className="menu-item  menu-item-has-children">
                                            <a href="#">Contact</a>
                                            <ul className="sub-menu">
                                                <li className="menu-item"><a href="contact1.html">Contact 1</a></li>
                                                <li className="menu-item"><a href="contact2.html">Contact 2</a></li>
                                            </ul>
                                        </li>
                                    </ul>
                                </nav>
                                ...
                                <div className="flat-search-btn flex">
                                        ...
                                        <div className="top-search">
                                            {/*<form action="#" method="get" role="search" className="search-form">
                                                <input type="search" id="s" className="search-field"
                                                       placeholder="Search..." value={searchValue} name="s" title="Search for"
                                                       />
                                                    <button className="search search-submit" type="submit" onClick={() = setSearchValue(searchInput)}
                                                            title="Search">
                                    ...
                                    <div className="sc-btn-top mg-r-12" id="site-header">
                                        <a href="connect-wallet.html" id="connectbtn"
                                           className="sc-button header-slider style style-1 wallet fl-button pri-1"><span>Wallet connect
                                            </span></a>
                                    </div>
                                        ...
                                        <div className="header_avatar">
                                                                ...
                                                                <div className="wrap-box">
                                                                    ...
                                                                    <div className="sc-box">
                                                                        <div className="content">
                                                                            ...
                                                                            <div className="infor">
                                                                                <span
                                                                                    className="fw-7">Tyler Covington</span>
                                            ...
                                            <div className="popup-user">
                                                ...
                                                <div className="avatar_popup mt-20">
                                                    ...
                                                    <p>Wallet</p>
                                                    <div
                                                        className="d-flex align-items-center justify-content-between mg-t-5 mg-bt-17">
                                                        <p> 0x84569v....3d5t7e5fd</p>
                                                        <a href="index-2.html" className="ml-2">
