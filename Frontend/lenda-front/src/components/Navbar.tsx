                                        ...
                                        <ul id="menu-primary-menu" className="menu">
                                            <li className="menu-item current-menu-item menu-item-has-children">
                                                ...
                                                <ul className="sub-menu">
                                                    <li className="menu-item current-item"><a >Home 1</a>
                                                    </li>
                                                    <li className="menu-item"><a >Home 2</a></li>
                                                    <li className="menu-item"><a >Home 3</a></li>
                                                    <li className="menu-item"><a >Home 4</a></li>
                                                    <li className="menu-item"><a >Home 5</a></li>
                                                    <li className="menu-item"><a >Home 6</a></li>
                                                    <li className="menu-item"><a >Home 7</a></li>
                                                    <li className="menu-item"><a >Home 8 ( Special )</a>
                                                    </li>
                                                    <li className="menu-item menu-item-has-children">
                                                        <a href="#">Slider Styles</a>
                                                        <ul className="sub-menu">
                                                            <li className="menu-item"><a >Text
                                                                Type</a></li>
                                                            <li className="menu-item"><a >Text
                                                                Scroll</a></li>
                                                            <li className="menu-item"><a >Text
                                            ...
                                            <li className="menu-item menu-item-has-children">
                                                <a href="#">Explore</a>
                                                <ul className="sub-menu">
                                                    <li className="menu-item"><a >Explore Style 1</a>
                                                    </li>
                                                    <li className="menu-item"><a >Explore Style 2</a>
                                                    </li>
                                                    <li className="menu-item"><a >Explore Style 3</a>
                                                    </li>
                                                    <li className="menu-item"><a >Explore Style 4</a>
                                                    </li>
                                                    <li className="menu-item"><a >Live Auctions</a></li>
                                                    <li className="menu-item"><a >Item Details</a>
                                                    </li>
                                                    <li className="menu-item"><a >Item Details
                                                        2</a></li>
                                                </ul>
                                            </li>
                                            <li className="menu-item menu-item-has-children">
                                                <a href="#">Activity</a>
                                                <ul className="sub-menu">
                                                    <li className="menu-item"><a >Activity 1</a></li>
                                                    <li className="menu-item"><a >Activity 2</a></li>
                                                </ul>
                                            </li>
                                            <li className="menu-item menu-item-has-children">
                                                <a href="#">Community</a>
                                                <ul className="sub-menu">
                                                    <li className="menu-item"><a >Blog</a></li>
                                                    <li className="menu-item"><a >Blog Details</a>
                                                    </li>
                                                    <li className="menu-item"><a >Help Center</a>
                                                    </li>
                                                </ul>
                                            </li>
                                            <li className="menu-item menu-item-has-children">
                                                <a href="#">Pages</a>
                                                <ul className="sub-menu">
                                                    <li className="menu-item"><a >Authors</a></li>
                                                    <li className="menu-item"><a >Authors 2</a></li>
                                                    <li className="menu-item"><a >Wallet
                                                        Connect</a></li>
                                                    <li className="menu-item"><a >Create Item</a>
                                                    </li>
                                                    <li className="menu-item"><a >Edit Profile</a></li>

                                                    <li className="menu-item"><a >Ranking</a></li>
                                                    <li className="menu-item"><a >Login</a></li>
                                                    <li className="menu-item"><a >Sign Up</a></li>
                                                    <li className="menu-item"><a >No Result</a></li>
                                                    <li className="menu-item"><a >FAQ</a></li>
                                                </ul>
                                            </li>
                                            <li className="menu-item  menu-item-has-children">
                                                <a href="#">Contact</a>
                                                <ul className="sub-menu">
                                                    <li className="menu-item"><a >Contact 1</a></li>
                                                    <li className="menu-item"><a >Contact 2</a></li>
                                                </ul>
                                            </li>
                                        </ul>
                                    </nav>
