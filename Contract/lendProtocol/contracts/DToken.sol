 ...
 */
contract DToken is Initializable, IDToken, IncentivizedERC20 {
  ...
  /**
   * @dev Initializes the DToken
   * @param addressProvider The address of the address provider where this DToken will be used
   * @param treasury The address of the treasury, receiving the fees on this DToken
   * @param underlyingAsset The address of the underlying asset of this DToken
   */
  function initialize(
    ...
    __IncentivizedERC20_init(DTokenName, DTokenSymbol, DTokenDecimals);
  ...
  /**
   * @dev calculates the total supply of the specific DToken
  ...
  /**
   * @dev Returns the address of the treasury, receiving the fees on this DToken
   **/
  ...
  /**
   * @dev Returns the address of the underlying asset of this DToken
   **/
  ...
  /**
   * @dev Returns the address of the lending pool where this DToken is used
   **/
   ...
   * @param target The recipient of the DTokens
  ...
  /**
   * @dev Transfers the DTokens between two users. Validates the transfer
